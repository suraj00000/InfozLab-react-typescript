    ...
    return (
        <div className='my-3'>
            <Card style={{ width: '18rem' }}>
                ...
                <Card.Img variant="top" src={imageUrl} className="mx-auto d-block" style={{ objectFit: "scale-down", height: "286px", width: "180px" }} />
                <Card.Body>
                    ...
                    <Button variant="dark" href={readMoreUrl} target="_blank">Go somewhere</Button>
                </Card.Body>
            </Card>
            {/* <div className='my-3 '>
                <div className="card" style={{ width: "18rem" }}>
                    ...
                    <div className="card-body">
                        ...
                        <a href={props.readMoreUrl} target="_blank" rel='noreferrer' className="btn btn-sm btn-dark">Read More</a>
